...
namespace BHLVT.Areas.CRM.Controllers.General
{
    ...
    {
        CustomerSourceController cs = new CustomerSourceController();
        // GET: CRM/Provs
        public ActionResult Index()
        {
          ...
          //  var p = db.tblcities.Where(x => x.cityid == "GLAI").FirstOrDefault();
            ...
            return (ActionResult)cs.Index(Request)["view"];
        }
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Index(tblcustomersource c)
        {
            return (ActionResult)cs.IndexPost(Request, c)["view"];
        }
        ...
        {
            return (ActionResult)cs.Delete(Request)["view"];
        }
    }
}