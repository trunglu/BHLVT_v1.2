...
function addRow(tableID) {
    ...
    for (var i = 0; i < colCount; i++) {
        ...
        if (i == 1) {
            ...
            //newcell.className = "hidden";
            newcell.innerHTML = '<div style="width:70px">' + '<input type="text" name="l_poct2[' + (rowCount - 1) + '].dvt" class="form-control input-sm" id="l_poct2_' + (rowCount - 1) + '__dvt" value=""  placeholder="" style="width:70px"/>' + '</div>'
            ;
            ...
            //newcell.innerHTML = '<input type="text" class="form-control thanhtoan" readonly name="thanhtoan[' + (rowCount - 1) + ']" id="thanhtoan' + (rowCount - 1) + '" value="0" style="text-align:right; width:130px;"/>';
            newcell.innerHTML = '<div style="width:70px">' + '<input type="text" name="l_poct2[' + (rowCount - 1) + '].thue_gtgt" class="form-control input-sm" id="l_poct2_' + (rowCount - 1) + '__thue_gtgt" value=""  placeholder=""/>' + '</div>'

        } else if (i == 13) {
            //newcell.innerHTML = '<input type="text" class="form-control thanhtoan" readonly name="thanhtoan[' + (rowCount - 1) + ']" id="thanhtoan' + (rowCount - 1) + '" value="0" style="text-align:right; width:130px;"/>';
            newcell.innerHTML = '<div style="width:100px">' + '<input type="text" name="l_poct2[' + (rowCount - 1) + '].thue_gtgt_nt" class="form-control input-sm" id="l_poct2_' + (rowCount - 1) + '__thue_gtgt_nt" value=""  placeholder=""/>' + '</div>'

        } else if (i == 14) {
            //newcell.innerHTML = '<input type="text" class="form-control thanhtoan" readonly name="thanhtoan[' + (rowCount - 1) + ']" id="thanhtoan' + (rowCount - 1) + '" value="0" style="text-align:right; width:130px;"/>';
            newcell.innerHTML = '<div style="width:70px">' + '<input type="text" name="l_poct2[' + (rowCount - 1) + '].tt" class="form-control input-sm" id="l_poct2_' + (rowCount - 1) + '__tt" value=""  placeholder=""/>' + '</div>'

        } else if (i == 15) {
            //newcell.innerHTML = '<input type="text" class="form-control thanhtoan" readonly name="thanhtoan[' + (rowCount - 1) + ']" id="thanhtoan' + (rowCount - 1) + '" value="0" style="text-align:right; width:130px;"/>';
            newcell.innerHTML = '<div style="width:100px">' + '<input type="text" name="l_poct2[' + (rowCount - 1) + '].tt_nt" class="form-control input-sm" id="l_poct2_' + (rowCount - 1) + '__tt_nt" value=""  placeholder=""/>' + '</div>'

        } else if (i == 16) {
            //newcell.innerHTML = '<input type="text" class="form-control thanhtoan" readonly name="thanhtoan[' + (rowCount - 1) + ']" id="thanhtoan' + (rowCount - 1) + '" value="0" style="text-align:right; width:130px;"/>';
            newcell.innerHTML = '<div style="width:70px">' + '<input type="text" name="l_poct2[' + (rowCount - 1) + '].tk_vt" class="form-control input-sm" id="l_poct2_' + (rowCount - 1) + '__tk_vt" value=""  placeholder=""/>' + '</div>'

        } else if (i == 17) {
            //newcell.innerHTML = '<input type="text" class="form-control thanhtoan" readonly name="thanhtoan[' + (rowCount - 1) + ']" id="thanhtoan' + (rowCount - 1) + '" value="0" style="text-align:right; width:130px;"/>';
            newcell.innerHTML = '<div style="width:70px">' + '<input type="text" name="l_poct2[' + (rowCount - 1) + '].tk_thue_gtgt_no" class="form-control input-sm" id="l_poct2_' + (rowCount - 1) + '__tk_thue_gtgt_no" value=""  placeholder=""/>' + '</div>'

        } else if (i == 18) {
            //newcell.innerHTML = '<input type="text" class="form-control thanhtoan" readonly name="thanhtoan[' + (rowCount - 1) + ']" id="thanhtoan' + (rowCount - 1) + '" value="0" style="text-align:right; width:130px;"/>';
            newcell.innerHTML = '<div style="width:70px">' + '<input type="text" name="l_poct2[' + (rowCount - 1) + '].so_lsx" class="form-control input-sm" id="l_poct2_' + (rowCount - 1) + '__so_lsx" value=""  placeholder=""/>' + '</div>'

        } else if (i == 19) {
            //newcell.innerHTML = '<input type="text" class="form-control thanhtoan" readonly name="thanhtoan[' + (rowCount - 1) + ']" id="thanhtoan' + (rowCount - 1) + '" value="0" style="text-align:right; width:130px;"/>';
            newcell.innerHTML = '<div style="width:70px">' + '<input type="text" name="l_poct2[' + (rowCount - 1) + '].so_ycsx" class="form-control input-sm" id="l_poct2_' + (rowCount - 1) + '__so_ycsx" value=""  placeholder=""/>' + '</div>'

        } else if (i == 20) {
            //newcell.innerHTML = '<input type="text" class="form-control thanhtoan" readonly name="thanhtoan[' + (rowCount - 1) + ']" id="thanhtoan' + (rowCount - 1) + '" value="0" style="text-align:right; width:130px;"/>';
            newcell.innerHTML = '<div style="width:70px">' + '<input type="text" name="l_poct2[' + (rowCount - 1) + '].quy_cach" class="form-control input-sm" id="l_poct2_' + (rowCount - 1) + '__quy_cach" value=""  placeholder=""/>' + '</div>'
...
function deleteRow(tableID) {
    try {
        if (confirm("Bạn muốn xóa những mục đã chọn ?")) {
            var table = document.getElementById(tableID);
            var rowCount = table.rows.length;
            //console.log(rowCount); return;
            for (var i = 0; i < rowCount; i++) {
                var row = table.rows[i];
                var chkbox = row.cells[0].childNodes[1];
                if (typeof (chkbox) != 'undefined') {
                    //console.log(chkbox.childNodes);
...
var onChangeHangHoa = function (index, data) {
    var ma_vt = $('#l_poct2_' + index + '__ma_vt').combobox('getValue');
    ...
    jQuery.ajax({
        ...
        success: function (response) {
            ...
            $('#l_poct2_'+index+'__dvt').combobox({
                ...
                editable: false,
                required: true,
                validType: 'exists["#l_poct2_' + index + '__dvt"]',
                onSelect: function () {
                    // alert('abc');
                    if (data != null) {
                ...
                onLoadSuccess: function () {
                    ...
                    if (data != null) {
                        $('#l_poct2_' + index + '__dvt').combobox('select', data.donvi);
                    } else {
                        if ($.trim(response) != '') {
                            var data__ = JSON.parse(response);
                            if (typeof (data__[0]) != "undefined") {
                                $('#l_poct2_' + index + '__dvt').combobox('select', data__[0].id);
                            }
                        }
                    }
                    setTimeout(function () {
